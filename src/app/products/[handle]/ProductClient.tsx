          ...
          <div className="flex flex-col">
            ...
            <div className="space-y-4 mb-12">
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="w-full h-16 text-sm font-black tracking-[0.2em] border-2 border-text-dark text-text-dark hover:bg-text-dark hover:text-white rounded-none transition-all"
